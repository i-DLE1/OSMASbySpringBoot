...
DROP TABLE TBL_ADMIN_BOARD;
DROP TABLE TBL_ADMIN_BOARD_FILE;
DROP TABLE TBL_ALERT;
DROP TABLE TBL_CATEGORY;
DROP TABLE TBL_DELIVERY_STATUS;
DROP TABLE TBL_MEMBER;
DROP TABLE TBL_MEMBER_ROLE;
DROP TABLE TBL_PAYMENT;
DROP TABLE TBL_PAYMENT_HISTORY;
DROP TABLE TBL_PERMISSION_ROLE;
DROP TABLE TBL_PRJ;
DROP TABLE TBL_PRJ_FAQ;
DROP TABLE TBL_PRJ_FILE;
DROP TABLE TBL_PRJ_NEW_INFO;
DROP TABLE TBL_PRJ_NEW_INFO_FILE;
DROP TABLE TBL_PRJ_PRODUCT_LIST;
DROP TABLE TBL_PRJ_PROGRESS;
DROP TABLE TBL_PRJ_QNA;
DROP TABLE TBL_PRJ_QNA_ANSWER;
DROP TABLE TBL_PRJ_WISH;
DROP TABLE TBL_PRODUCT;
DROP TABLE TBL_REVIEW;
DROP TABLE TBL_ROLE_LIST;
DROP TABLE TBL_SELLER_ROLE;
DROP TABLE TBL_SELLER_ROLE_FILE;
DROP TABLE TBL_SELLER_ROLE_REQ;
DROP TABLE TBL_SHIPPING_TRACK_INFO;
DROP TABLE TBL_SPONSORED_PRJ;
DROP TABLE TBL_SUGGEST;
DROP TABLE TBL_TERMS;
DROP TABLE TBL_TERMS_HISTORY;
...
COMMENT ON COLUMN TBL_MEMBER.ROLE IS '권한';
...
COMMENT ON COLUMN TBL_PRJ.LAST_DATE IS '마지막수정날짜';
...
COMMENT ON COLUMN TBL_PRJ_FILE.PATH IS '파일경로';
